...
//            if (s.stack == null)
			...
			for (var z in other)	// loop through all values of the array (otherwise we only increment by the next one series' value)
			{
                            if (other[z].datapoints) {
