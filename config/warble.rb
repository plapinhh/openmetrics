...
Warbler::Config.new do |config|
  ...
  config.gems += ["rack", "activerecord-jdbcpostgresql-adapter", "jruby-openssl", "net-ssh", "net-sftp", "jruby-ldap", "bb-ruby", "packet", "chronic", "ffi", "rrd-ffi"]
  # config.gems << "tzinfo"
  ...
  # have a look at http://docs.sun.com/app/docs/doc/820-4926/ghone?l=en&a=view
