backgroundrb_tasks.rake removed to suspress DEPRECATION WARNING when using rake:
DEPRECATION WARNING: Rake tasks in vendor/plugins/backgroundrb/tasks are deprecated. Use lib/tasks instead. (called from /usr/lib/ruby/gems/1.8/gems/rails-2.3.8/lib/tasks/rails.rb:10)
